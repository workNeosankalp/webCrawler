...
const Home = () => {
  ...
  useEffect(() => {
    const fetchFeaturedPrompts = async () => {
      try {
        const response = await axios.get("/api/prompts?limit=3");
        setFeaturedPrompts(response.data.slice(0, 3));
      } catch (error) {
    ...
    <>
      <div ref={containerRef} className="min-h-screen bg-white overflow-hidden">
        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            style={{ y: y2 }}
            className="absolute bottom-20 right-10 w-96 h-96 bg-[#FF6B6B]/10 rounded-full blur-3xl"
          />
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="inline-flex items-center px-4 py-2 bg-[#FF6B6B]/10 border border-[#FF6B6B]/30 rounded-full mb-8"
            >
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl lg:text-8xl font-bold text-gray-900 mb-6 tracking-tight leading-tight"
            >
            ...
            >
              <Link
                to="/prompts"
                className="px-10 py-4 bg-gradient-to-r from-[#FF6B6B] to-[#D64639] text-white rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-[#FF6B6B]/50 transition-all duration-300 transform hover:scale-105"
              >
                Explore Prompts
              </Link>
              <Link
                to="/learn-more"
                className="px-10 py-4 bg-transparent text-gray-900 rounded-full font-semibold text-lg border-2 border-gray-300 hover:border-[#FF6B6B]/60 backdrop-blur-sm transition-all duration-300"
              >
                Learn More →
              </Link>
            </motion.div>
        ...
        <section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gray-50">
          <div className="max-w-7xl mx-auto">
                      ...
                      <div className="bg-white backdrop-blur-sm border border-gray-200 rounded-2xl overflow-hidden hover:border-[#FF6B6B]/60 transition-all duration-500 hover:shadow-2xl hover:shadow-[#FF6B6B]/20 hover:-translate-y-2">
                        ...
                        <div className="p-6">
                          ...
                          <div className="flex items-center justify-between pt-4 border-t border-gray-200">
                            ...
                            <button className="text-[#FF6B6B] hover:text-[#D64639] transition-colors text-sm font-medium">
                              Use Prompt →
                            </button>
                          </div>
                        </div>
            ...
            >
              <Link
                to="/prompts"
                className="inline-flex items-center px-8 py-4 bg-white text-gray-900 rounded-full font-semibold border-2 border-gray-300 hover:border-[#FF6B6B]/60 hover:bg-[#FF6B6B]/5 transition-all duration-300 hover:shadow-lg hover:shadow-[#FF6B6B]/20"
              >
                View All Prompts
                <svg
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
                transition={{ duration: 0.6 }}
                className="bg-white border border-gray-200 rounded-2xl p-8 hover:border-[#FF6B6B]/60 transition-all duration-300 hover:shadow-xl hover:shadow-[#FF6B6B]/20"
              >
                <div className="w-14 h-14 bg-[#FF6B6B]/10 rounded-xl flex items-center justify-center mb-6">
                  <svg
        ...
        <section className="relative py-32 px-4 sm:px-6 lg:px-8 bg-gray-50">
          ...
          >
            <div className="bg-gradient-to-r from-[#FF6B6B]/10 via-[#D64639]/10 to-[#FF6B6B]/10 border border-[#FF6B6B]/30 rounded-3xl p-12 md:p-16 text-center relative overflow-hidden">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-[#FF6B6B]/5 via-transparent to-transparent"></div>
              ...
              <div className="relative z-10">
                ...
                <Link
                  to="/prompts"
                  className="inline-flex items-center px-10 py-4 bg-gradient-to-r from-[#FF6B6B] to-[#D64639] text-white rounded-full font-semibold text-lg hover:shadow-2xl hover:shadow-[#FF6B6B]/50 transition-all duration-300 transform hover:scale-105"
                >
                  Explore All Prompts
                  <svg
                    className="w-5 h-5 ml-2"
